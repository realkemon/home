...
In an attempt to locate a secret Rocket Base in occupied Norway, the Allies launch a stealth attack on an Axis outpost with a submarine. Facing the Allied advances, the Axis quickly retreated to a nearby storage facility and abandoned the coastal fortress leaving behind crucial documents depicting the location of the secret Rocket Base. 
